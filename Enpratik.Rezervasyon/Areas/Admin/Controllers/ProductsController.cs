...
namespace Enpratik.AdminPanel.Controllers
{
    public class ProductsController : BaseController
    {
        ...
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult QuickEdit(ProductDTO product)
        {
            ...
            products.Price = string.IsNullOrEmpty(product.Price) ? 0 : Convert.ToDouble(product.Price.Replace(".", ","));
            products.Tax = product.Tax;
            products.StockQuantity = product.StockQuantity;
            products.MetaTitle = product.MetaTitle;
            products.MetaKeywords = product.MetaKeywords;
            products.MetaDescription = product.MetaDescription;
