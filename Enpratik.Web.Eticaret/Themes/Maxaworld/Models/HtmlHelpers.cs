...
namespace Enpratik.Web.Eticaret.Maxaworld
{
    public static class HtmlHelpers
    {
        ...
        private static void GetSubMenu(List<Menus> menuList, Menus menu, StringBuilder sb)
        {
            ...
            foreach (Menus item in subMenuList)
            {
                ...
                sb.Append("<li class=\"menu-item\"><a href=\"" + item.MenuUrl + "\">" + item.MenuName + "</a></li>");
            ...
            if (counter > 0)
            {
                sb.Replace("{@}", " class=\"menu-item menu-item-has-children\"");
                sb.Append("</ul>");
            }
            else
            {
                sb.Replace("{@}", " class=\"menu-item\"");
                sb.Replace("{@}", "");
            }
            sb.Append("</li>");
        }
