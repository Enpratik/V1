...
namespace Enpratik.AdminPanel.Controllers
{
    public class PaymentMethodsController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,PaymentMethodName,Descriptions,LanguageId,IsActive")] PaymentMethods paymentMethods)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PaymentMethodName,Descriptions,LanguageId,IsActive")] PaymentMethods paymentMethods)
        {
            if (ModelState.IsValid)
            {
